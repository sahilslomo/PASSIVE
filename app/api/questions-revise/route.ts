...
export async function POST(req: Request) {
    try {
        ...
        const combinedFilesText = globalFilesText;
        ...
        const prompt = `
You are Navik AI Study Genie.

Generate the BEST POSSIBLE revision notes using ALL available learning material.

Use:
- all questions and answers
- all transcripts
- all approved study files
- all topic knowledge

Your job:
- deeply explain concepts
- simplify difficult ideas
- create exam-focused notes
- generate memory tricks
- connect concepts together
- create fast revision bullets
- help long-term understanding
...
Generate highly structured smart revision notes.
`;
        /* =========================
           DEBUG: PROMPT SIZE
        ========================= */
